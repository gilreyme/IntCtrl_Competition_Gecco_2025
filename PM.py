...
def main():
    ...
    env = gym.make("Pong-v4", mode=0, difficulty=0, obs_type='rgb', render_mode='rgb_array', full_action_space=False)
    ...
    with open("resultado.csv", mode="w", newline="") as file:
        ...
        writer.writerow(["FramesSurvived", "GoalsScored", "GoalsConceded"])
        writer.writerow([frames_survived, goals_scored, goals_conceded])
